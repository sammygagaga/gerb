...
{{--                    <li class="flex items-center p-3 bg-green-50 rounded hover:bg-green-100 transition mb-2">--}}
...
{{--            <ul class="space-y-3">--}}
{{--                <a href="{{ route('products.product', $product) }}">--}}
{{--                    <li class="flex items-center p-3 bg-red-50 rounded hover:bg-red-100 transition mb-2">--}}
