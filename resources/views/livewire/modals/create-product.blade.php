<!-- Форма добавления -->
<div class="bg-white rounded-1xl shadow-lg p-8 border border-gray-100">
        ...
        <div>
            ...
            <div class="bg-[#F2F3F7] p-1 rounded-xl flex">
                <label class="flex-1 cursor-pointer">
                    <input wire:model="form.allowed" type="radio" value="1" class="peer sr-only" checked>
                    <div
                        class="text-center py-3 rounded-lg peer-checked:bg-[#00A651] peer-checked:text-white text-gray-600 font-medium transition-all duration-300">
                        Можно употреблять
                    </div>
                </label>
                <label class="flex-1 cursor-pointer">
                    <input wire:model="form.allowed" type="radio" value="0" class="peer sr-only">
                    <div
                        class="text-center py-3 rounded-lg peer-checked:bg-[#EB5757] peer-checked:text-white text-gray-600 font-medium transition-all duration-300">
                        Нельзя употреблять
                    </div>
                </label>
            </div>
